        ...
        <div class="card-body">
            <form action="inscription.php" method="post">
                <div class="row">
                    <div class="col-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" required class="form-control" id="username" name="username" placeholder="Pseudo">
                        </div>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <div class="form-group mb-3">
                            <label for="password" class="mb-3">Confirmer le mot de passe</label>
                            <input type="password" required class="form-control" id="password" name="password" placeholder="Mot de passe">
                        </div>
                    </div>
                </div>
                <div class="row justify-content-end">
                    ...
                    <?php endif; ?>
                    <div class="col-auto me-2 mt-2">
                        <button type="submit" name="submit" class="btn btn-primary align-self-end">Inscription</button>
                    </div>
                </div>
            </form>
        </div>
